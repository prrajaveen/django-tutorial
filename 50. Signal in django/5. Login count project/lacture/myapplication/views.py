...
def dashboard(request):
    if request.user.is_authenticated:
        ...
        ct=cache.get('count',version=request.user.id)
        return render(request,'myapplication/dashboard.html',{'form':fm,'post':blogpost,'dashboardcolor':'text-warning','ip':ip,'logincount':ct})
    else:
